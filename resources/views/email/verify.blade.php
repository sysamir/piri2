            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Hesabın aktiv edilməsi</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Salam,</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Gotender.az saytında qeydiyyatınızın 1-ci mərhələsi tamamlandı. Hesabı aktiv etmək üçün e-poçt ünvanı təsdiqlənməlidir. Zəhmət olmasa aşağıdakı düyməyə klik edərək aktiv edin.
                            </td>
                          </tr>
                        </table>
                        <div><!--[if mso]>
                        ...
                        <![endif]--><a href="{{ URL::to('register/verify/' . $kod) }}"
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="http://gotender.az/elaqe"><b>Əlaqə</b></a> səhifəsinə keçərək kömək ala bilərsiniz.
          </div>
        </td>
        <td></td>
      </tr>
